...
module mkTbActivationSRAMDB();
   ...
   rule do_w1 (cycle == 0);
      as.write(0, mk_row(10));      // → inactive (B)[0] = [10,11,12,13]
   endrule
   rule do_swap1 (cycle == 2); as.swap; endrule
   rule do_r1 (cycle == 4); as.readReq(0); endrule
   ...
   rule do_w2 (cycle == 8); as.write(0, mk_row(100)); endrule
   rule do_r2 (cycle == 10); as.readReq(0); endrule
   ...
   rule do_r3 (cycle == 16); as.readReq(0); endrule
